...
public:
    ...
    void insertTail(int x)
    {
        ...
        else // ngược lại thêm node mới tại tail->next và cập nhật tail
        {
    ...
    // hàm xuất linked list
    void printList()
    {
        node *temp = head;
        while (temp != nullptr) // duyệt tới phần tử cuối danh sách
        {
            cout << temp->data << " ";
            temp = temp->next;
        }
...
int main()
{
    ...
    // b.printList();
    // cout << "size: " << b.size() << endl;
    // cout << "Tim nut 5: " << boolalpha << b.search(5) << endl;
    // cout << "----------------Xoa--------------" << endl;
    // b.delAt();
    // b.delHead();
    // b.delTail();
